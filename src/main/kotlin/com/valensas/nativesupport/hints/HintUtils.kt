...
object HintUtils {
    ...
    fun registerSerializationHints(
        hints: RuntimeHints,
        clazz: Class<*>,
    ...
    private fun registerCustomSerializationHints(
        ...
        val customSerializationMapping =
            listOf(
    ...
    private fun registerPrimitiveSerializationHints(
        clazz: Class<*>,
        hints: RuntimeHints
    ) {
        ...
        val boxedType =
            primitiveToBoxed[clazz.canonicalName] ?: throw Exception(
     ...
     */
    private fun registerInterfaceSerializationHints(
        hints: RuntimeHints,
        clazz: Class<*>,
        classLoader: ClassLoader
    ) {
